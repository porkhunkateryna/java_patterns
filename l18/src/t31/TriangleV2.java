...
public class TriangleV2 implements Triangle {
    ...
    public TriangleV2(float a, float b, float c) {
    ...
    public void restore(Memento memento) {
        if (memento instanceof TriangleMemento triangleMemento) {
            this.a = triangleMemento.getA();
            this.b = triangleMemento.getB();
            this.c = triangleMemento.getC();
        }
    }
}
