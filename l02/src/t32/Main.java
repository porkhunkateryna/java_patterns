...
import t32.factory.BiQuadraticEqFactory;
import t32.factory.LinearEqFactory;
import t32.factory.QuadraticEqFactory;
...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        for (int i = 0; i < 1; i++) {
            ...
            try (FileReader fileReader = new FileReader("C://Users//katyu//IdeaProjects//l02//src//t32//files/input0" + (i + 1) + ".txt")) {
